...
const staticCacheName = 'MobilevisitPWAN1_pwa_cache-v-01.01';
const dynamicCacheName = 'MobilevisitPWAN1_pwa_dynamic_cache-v-01.01';
const dynamicCacheSize = 77;
const offlineFilename = '/pwatest/offline.html';
